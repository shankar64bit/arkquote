import 'package:flutter_testreports/features/testreport/domain/entities/equipment/AT/AT_r.dart';

import '../../../../domain/entities/equipment/AT/AT_wrLv.dart';

class AT_R_Model extends AT_R {
  const AT_R_Model({
    final int id,
  ...
  factory AT_R_Model.fromJson(Map<String, dynamic> json) {
    return AT_R_Model(
      id: json['id'],
