import 'package:flutter_testreports/features/testreport/domain/entities/equipment/LA/lightning_arrester.dart';

class LaModel extends LightningArrester {
  const LaModel({
    final String etype,
  ...
  factory LaModel.fromJson(Map<String, dynamic> json) {
    return LaModel(
      etype: json['etype'],
