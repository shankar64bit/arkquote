import '../../../../../domain/entities/equipment/Relays/FPrelay/FPR_overfreq.dart';

class FPRoverfreqModel extends FPRoverfreq {
  const FPRoverfreqModel({
    final int id,
  ...
  factory FPRoverfreqModel.fromJson(Map<String, dynamic> json) {
    return FPRoverfreqModel(
      id: json['id'],
