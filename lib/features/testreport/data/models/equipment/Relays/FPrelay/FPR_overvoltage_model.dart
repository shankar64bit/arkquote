import '../../../../../domain/entities/equipment/Relays/FPrelay/FPR_overvoltage.dart';

class FPRovervoltageModel extends FPRovervoltage {
  const FPRovervoltageModel({
    final int id,
  ...
  factory FPRovervoltageModel.fromJson(Map<String, dynamic> json) {
    return FPRovervoltageModel(
      id: json['id'],
