...
class EnergyMeterAprpTestModel extends EnergyMeterAprpTest {
  const EnergyMeterAprpTestModel({
    final int id,
  ...
  factory EnergyMeterAprpTestModel.fromJson(Map<String, dynamic> json) {
    return EnergyMeterAprpTestModel(
      id: json['id'],
