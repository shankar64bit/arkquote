...
class EnergyMeterApTestModel extends EnergyMeterApTest {
  const EnergyMeterApTestModel({
    final int id,
  ...
  factory EnergyMeterApTestModel.fromJson(Map<String, dynamic> json) {
    return EnergyMeterApTestModel(
      id: json['id'],
