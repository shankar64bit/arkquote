import '../../../../domain/entities/equipment/powt/powt_mb.dart';

class Powt_mb_Model extends Powt_mb {
  const Powt_mb_Model({
    final int id,
  ...
  factory Powt_mb_Model.fromJson(Map<String, dynamic> json) {
    return Powt_mb_Model(
      id: json['id'],
