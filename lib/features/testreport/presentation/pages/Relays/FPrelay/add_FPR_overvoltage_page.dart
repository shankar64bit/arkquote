...
class Add_FPRovervoltage_Details extends StatelessWidget with GetItMixin {
  Map args = {};
  int FPR_ID;
  int TR_ID;

  Add_FPRovervoltage_Details(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    setTrNo();
    var mob =
        Text('Add FPRovervoltage Details', style: TextStyle(fontSize: 17));
    var desk =
        Text('Add FPRovervoltage Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final FPRovervoltageModel FPRovervoltagetoLocal =
                      FPRovervoltageModel(
                  ...
                  print(FPRovervoltagetoLocal);
                  print(FPRovervoltagetoLocal.trNo);
                  getX((FPRovervoltageProvider x) =>
                      x.addFPRovervoltage(FPRovervoltagetoLocal));
                  watchOnly((FPRovervoltageProvider x) => {});
