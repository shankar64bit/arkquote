...
class Add_FPRunderfreq_Details extends StatelessWidget with GetItMixin {
  Map args = {};
  int FPR_ID;
  int TR_ID;

  Add_FPRunderfreq_Details(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    setTrNo();
    var mob = Text('Add FPRunderfreq Details', style: TextStyle(fontSize: 17));
    var desk = Text('Add FPRunderfreq Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final FPRunderfreqModel FPRunderfreqtoLocal =
                      FPRunderfreqModel(
                  ...
                  print(FPRunderfreqtoLocal);
                  print(FPRunderfreqtoLocal.trNo);
                  getX((FPRunderfreqProvider x) =>
                      x.addFPRunderfreq(FPRunderfreqtoLocal));
                  watchOnly((FPRunderfreqProvider x) => {});
