...
String etype_radio = 'fpr';
final _formKey = GlobalKey<FormState>();

class Add_FPrelay_Details extends StatelessWidget with GetItMixin {
  Map args = {};
  DateTime _dateOfTesting;
  Add_FPrelay_Details(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    setTrNo();
    var mob = Text('Add FPrelay Details', style: TextStyle(fontSize: 17));
    var desk = Text('Add FPrelay Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final FPrelayModel FPrelaytoLocal = FPrelayModel(
                  ...
                  getX((FPrelayProvider x) =>
                      x.addFPrelay(FPrelaytoLocal, _dateOfTesting));
