...
class EditFPRundervoltagePage extends StatelessWidget with GetItMixin {
  Map args = {};

  EditFPRundervoltagePage(this.args, {Key key}) : super(key: key);

  FPRundervoltageModel _fprundervoltageTestModel;
  ...
  Future<void> getReport() async {
    ...
    _fprundervoltageTestModel =
        watchOnly((FPRundervoltageProvider x) => x.fprundervoltage_Model);
    _IDcontroller.text = _fprundervoltageTestModel.id.toString();
    _trNo_controller.text = _fprundervoltageTestModel.trNo.toString();
    _serialNo_controller.text = _fprundervoltageTestModel.serialNo.toString();
    _voltageSet_controller.text =
        _fprundervoltageTestModel.voltageSet.toString();
    _delay_controller.text = _fprundervoltageTestModel.delay.toString();
    _rn_secVoltageSet_controller.text =
        _fprundervoltageTestModel.rn_secVoltageSet.toString();
    _rn_appliedSecVoltage_controller.text =
        _fprundervoltageTestModel.rn_appliedSecVoltage.toString();
    _rn_relayOprTime_controller.text =
        _fprundervoltageTestModel.rn_relayOprTime.toString();
    _yn_secVoltageSet_controller.text =
        _fprundervoltageTestModel.yn_secVoltageSet.toString();
    _yn_appliedSecVoltage_controller.text =
        _fprundervoltageTestModel.yn_appliedSecVoltage.toString();
    _yn_relayOprTime_controller.text =
        _fprundervoltageTestModel.yn_relayOprTime.toString();
    _bn_secVoltageSet_controller.text =
        _fprundervoltageTestModel.bn_secVoltageSet.toString();
    _bn_appliedSecVoltage_controller.text =
        _fprundervoltageTestModel.bn_appliedSecVoltage.toString();
    _bn_relayOprTime_controller.text =
        _fprundervoltageTestModel.bn_relayOprTime.toString();
    _stageNo_controller.text = _fprundervoltageTestModel.stageNo.toString();
    _function_controller.text = _fprundervoltageTestModel.function.toString();
  }

  @override
  Widget build(BuildContext context) {
    final FPRundervoltageModel ntr =
        watchOnly((FPRundervoltageProvider x) => x.fprundervoltage_Model);
    getReport();
    var mob = const Text('Edit FPR Undervoltage Details',
        style: TextStyle(fontSize: 15));
    var desk = const Text('Edit FPR Undervoltage Details',
              ...
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  if (response.statusCode == success_code ||
                    ...
                    final FPRundervoltageModel FPRundervoltageReportToLocal =
                    ...
                    getX((FPRundervoltageProvider x) => x.updateFPRundervoltage(
                        FPRundervoltageReportToLocal, args['id']));
                    Navigator.pop(context);

                    Navigator.popAndPushNamed(
                        context, '/detail_FPRundervoltage',
                        arguments: {
                          'id': args['id'],
                          'FPR_ID': args['FPR_ID'],
