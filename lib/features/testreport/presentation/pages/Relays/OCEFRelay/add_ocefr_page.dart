...
class AddOcEfrDetails extends StatelessWidget with GetItMixin {
  Map args = {};
  DateTime _dateOfTesting;
  AddOcEfrDetails(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    setTrNo();
    var mob = Text('Add Over Current Earth Fault  Details',
        style: TextStyle(fontSize: 17));
    var desk = Text('Add Over Current Earth Fault Details',
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final OcEfrModel OcEfrtoLocal = OcEfrModel(
                  ...
                  getX((OcEfrProvider x) =>
                      x.addOcEfr(OcEfrtoLocal, _dateOfTesting));
