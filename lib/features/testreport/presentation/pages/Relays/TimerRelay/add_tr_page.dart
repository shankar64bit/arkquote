...
String etype_radio = 'tr';
final _formKey = GlobalKey<FormState>();

class AddTrDetails extends StatelessWidget with GetItMixin {
  Map args = {};
  DateTime _dateOfTesting;
  AddTrDetails(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    setTrNo();
    var mob = Text('Add Timer Relay Details', style: TextStyle(fontSize: 17));
    var desk = Text('Add Timer Relay Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final TrModel TrtoLocal = TrModel(
                  ...
                  getX((TrProvider x) => x.addTr(TrtoLocal, _dateOfTesting));
