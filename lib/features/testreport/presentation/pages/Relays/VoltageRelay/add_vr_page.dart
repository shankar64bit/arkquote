...
class AddVrDetails extends StatelessWidget with GetItMixin {
  Map args = {};
  DateTime _dateOfTesting;
  AddVrDetails(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    setTrNo();
    var mob = Text('Add Voltage Relay Details', style: TextStyle(fontSize: 17));
    var desk =
        Text('Add Voltage Relay Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final VrModel VrtoLocal = VrModel(
                  ...
                  getX((VrProvider x) => x.addVr(VrtoLocal, _dateOfTesting));
