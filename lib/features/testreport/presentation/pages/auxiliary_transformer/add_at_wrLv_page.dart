...
class Add_AtwrLv_Details extends StatelessWidget with GetItMixin {
  Map args = {};
  int AT_ID;
  int TR_ID;

  Add_AtwrLv_Details(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    setTrNo();
    var mob = Text('Add ATwrLv Details', style: TextStyle(fontSize: 17));
    var desk = Text('Add ATwrLv Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final ATwrLv_Model ATwrLvtoLocal = ATwrLv_Model(
                  ...
                  print(ATwrLvtoLocal);
                  print(ATwrLvtoLocal.trNo);
                  getX((ATwrLv_Provider x) => x.addATwrLv(ATwrLvtoLocal));
                  watchOnly((ATwrLv_Provider x) => {});
