...
class EditBbHvPage extends StatelessWidget with GetItMixin {
  Map args = {};

  EditBbHvPage(this.args, {Key key}) : super(key: key);
  int _bbRefID;
  BbHvTestModel _bbHvTestModel;
  ...
  Future<void> getReport() async {
    ...
    _bbHvTestModel = watchOnly((BbHvProvider x) => x.bbHvModel);

    _IDcontroller.text = args['id'].toString();
    _nOcontroller.text = args['TrNo'].toString();
    _Rcontroller.text = _bbHvTestModel.r.toString();
    _Ycontroller.text = _bbHvTestModel.y.toString();
    _Bcontroller.text = _bbHvTestModel.b.toString();
    _Ncontroller.text = _bbHvTestModel.n.toString();

    _bbRefID = _bbHvTestModel.bbRefId;
  }

  @override
  Widget build(BuildContext context) {
    final BbHvTestModel ntr1 = watchOnly((BbHvProvider x) => x.bbHvModel);
    getX((BbProvider x) => x.getBbByID(args['BB_ID']));
    final BbModel ntr = watchOnly((BbProvider x) => x.bbModel);
    // print("_______");
    // print(ntr);
    getReport();
    var mob = const Text('Edit BB-HV Details', style: TextStyle(fontSize: 15));
    var desk = const Text('Edit BB-HV Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  //add to remote database
                  var url = Uri.parse('${Env.URL_PREFIX}/bbHvTest/' +
                  ...
                  if (response.statusCode == success_code ||
                    ...
                    final BbHvTestModel bbHvReportToLocal = BbHvTestModel(
                    ...
                    getX((BbHvProvider x) =>
                        x.updateBbHv(bbHvReportToLocal, args['id']));
                    Navigator.pop(context);

                    Navigator.popAndPushNamed(context, '/detail_BB_HV',
                        arguments: {
                          'id': args['id'],
              ...
              child: Column(children: [
                ...
                Padding(
                  ...
                  child: CustomTextFormFieldForNumber(
                    ...
                    hintText: 'R-Phase Measured Leakage Current (mA)',
                    validator: (val) {
                      if (!val.IsValueEmpty) {
                ...
                Padding(
                  ...
                  child: CustomTextFormFieldForNumber(
                    ...
                    hintText: 'Y-phase Measured Leakage Current (mA)',
                    validator: (val) {
                      if (!val.IsValueEmpty) {
                        return 'Field should not be empty';
                      }
                ...
                Padding(
                  ...
                  child: CustomTextFormFieldForNumber(
                    ...
                    hintText: 'B-Phase Measured Leakage Current (mA)',
                    validator: (val) {
                      if (!val.IsValueEmpty) {
                        return 'Field should not be empty';
                      }
                ...
                ntr.noOfBar == 4
                    ? Padding(
                        ...
                        child: CustomTextFormFieldForNumber(
                          ...
                          hintText: 'Neutral Measured Leakage Current (mA)',
                          validator: (val) {
                            if (!val.IsValueEmpty) {
                              return 'Field should not be empty';
                            }
