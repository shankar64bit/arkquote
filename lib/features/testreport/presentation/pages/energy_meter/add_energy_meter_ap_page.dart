...
class AddEnergyMeterApPage extends StatelessWidget with GetItMixin {
  Map args = {};
  int TR_ID;
  int EM_ID;

  AddEnergyMeterApPage(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    var mob = const Text('Add Energy Meter-AP Details',
        style: TextStyle(fontSize: 15));
    var desk = const Text('Add Energy Meter-AP  Details',
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  print(energyMeterApReportToLocal.serialNo);
                  getX((EnergyMeterApProvider x) =>
                      x.addEnergyMeterAp(energyMeterApReportToLocal));
                  watchOnly((EnergyMeterApProvider x) => {});
                  print("Energy Meter ap test  added");
