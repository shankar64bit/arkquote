...
class AddEnergyMeterAprpPage extends StatelessWidget with GetItMixin {
  Map args = {};
  int TR_ID;
  int EM_ID;

  AddEnergyMeterAprpPage(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    var mob = const Text('Add Energy Meter-APRP Details',
        style: TextStyle(fontSize: 15));
    var desk = const Text('Add Energy Meter-APRP  Details',
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final EnergyMeterAprpTestModel energyMeterAprpReportToLocal =
                  ...
                  print(energyMeterAprpReportToLocal.serialNo);
                  getX((EnergyMeterAprpProvider x) =>
                      x.addEnergyMeterAprp(energyMeterAprpReportToLocal));
                  watchOnly((EnergyMeterAprpProvider x) => {});
                  print("Energy Meter aprp added");
