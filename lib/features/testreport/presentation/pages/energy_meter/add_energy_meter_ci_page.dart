...
class AddEnergyMeterCiPage extends StatelessWidget with GetItMixin {
  Map args = {};
  int TR_ID;
  int EM_ID;

  AddEnergyMeterCiPage(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    var mob = const Text('Add Energy Meter-CI Details',
        style: TextStyle(fontSize: 15));
    var desk = const Text('Add Energy Meter-CI  Details',
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  print(energyMeterCiReportToLocal.serialNo);
                  getX((EnergyMeterCiProvider x) =>
                      x.addEnergyMeterCi(energyMeterCiReportToLocal));
                  watchOnly((EnergyMeterCiProvider x) => {});
                  print("Energy Meter Ci added");
