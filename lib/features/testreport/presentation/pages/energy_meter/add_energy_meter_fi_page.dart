...
class AddEnergyMeterFiPage extends StatelessWidget with GetItMixin {
  Map args = {};
  int TR_ID;
  int EM_ID;

  AddEnergyMeterFiPage(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    var mob = const Text('Add Energy Meter-FI Details',
        style: TextStyle(fontSize: 15));
    var desk = const Text('Add Energy Meter-FI  Details',
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  print(energyMeterFiReportToLocal.serialNo);
                  getX((EnergyMeterFiProvider x) =>
                      x.addEnergyMeterFi(energyMeterFiReportToLocal));
                  watchOnly((EnergyMeterFiProvider x) => {});
                  print("Energy Meter Fi added");
