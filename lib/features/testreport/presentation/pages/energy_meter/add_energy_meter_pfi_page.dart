...
class AddEnergyMeterPfiPage extends StatelessWidget with GetItMixin {
  Map args = {};
  int TR_ID;
  int EM_ID;

  AddEnergyMeterPfiPage(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    var mob = const Text('Add Energy Meter-PFI Details',
        style: TextStyle(fontSize: 15));
    var desk = const Text('Add Energy Meter-PFI  Details',
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  print(energyMeterPfiReportToLocal.serialNo);
                  getX((EnergyMeterPfiProvider x) =>
                      x.addEnergyMeterPfi(energyMeterPfiReportToLocal));
                  watchOnly((EnergyMeterPfiProvider x) => {});
                  print("Energy Meter PFi added");
