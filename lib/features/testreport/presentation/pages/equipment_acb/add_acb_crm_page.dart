...
class AddAcbCrmPage extends StatelessWidget with GetItMixin {
  Map args = {};
  int TR_ID;
  int ACB_ID;

  AddAcbCrmPage(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    var mob = const Text('Add ACB-CRM Details', style: TextStyle(fontSize: 15));
    var desk =
        const Text('Add ACB-CRM Details', style: TextStyle(fontSize: 20));
    var mobV =
        const Text('Add VCB-CRM Details', style: TextStyle(fontSize: 15));
    var deskV =
        const Text('Add VCB-CRM Details', style: TextStyle(fontSize: 20));
    var mobO =
        const Text('Add OCB-CRM Details', style: TextStyle(fontSize: 15));
    var deskO =
        const Text('Add OCB-CRM Details', style: TextStyle(fontSize: 20));
    var mobS =
        const Text('Add SF6-CRM Details', style: TextStyle(fontSize: 15));
    var deskS =
        const Text('Add SF6-CRM Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  print(acbCrmReportToLocal.serialNo);
                  getX((AcbCrmProvider x) => x.addACBCrm(acbCrmReportToLocal));
                  watchOnly((AcbCrmProvider x) => {});
                  print("ACB CRM added");
                  print(acbCrmReportToLocal);

                  Navigator.popAndPushNamed(context, '/detail_ACB',
                      arguments: {'id': args['ACB_ID'], 'trDatabaseID': TR_ID});
                }
              },
