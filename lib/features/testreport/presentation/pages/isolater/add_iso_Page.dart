...
String etype_radio = 'iso';
final _formKey = GlobalKey<FormState>();

class AddIsoDetails extends StatelessWidget with GetItMixin {
  Map args = {};
  DateTime _dateOfTesting;
  AddIsoDetails(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    setTrNo();
    var mob = Text('Add Isolator Details', style: TextStyle(fontSize: 17));
    var desk = Text('Add Isolator Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final IsoModel isoToLocal = IsoModel(
                  ...
                  print(isoToLocal);
                  getX((IsoProvider x) => x.addIso(isoToLocal, _dateOfTesting));
