...
String etype_radio = 'la';
final _formKey = GlobalKey<FormState>();

class AddLaDetails extends StatelessWidget with GetItMixin {
  Map args = {};
  DateTime _dateOfTesting;
  AddLaDetails(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    setTrNo();
    var mob =
        Text('Add Lightning Arrester Details', style: TextStyle(fontSize: 17));
    var desk =
        Text('Add Lightning Arrester Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final LaModel laToLocal = LaModel(
                  ...
                  print(laToLocal);
                  getX((LaProvider x) => x.addLa(laToLocal, _dateOfTesting));
