...
import 'package:flutter_testreports/features/testreport/data/models/equipment/powt/powt_r_model.dart';
...
import 'package:flutter_testreports/features/testreport/presentation/providers/powt_provider/powt_r_provider.dart';
...
class EditPowtRPage extends StatelessWidget with GetItMixin {
  Map args = {};

  EditPowtRPage(this.args, {Key key}) : super(key: key);
  ...
  Future<void> getReport() async {
    ...
    Powt_R_Model _powtRModel = watchOnly((Powt_R_Provider x) => x.powt_R_Model);

    _IDcontroller.text = args['id'].toString();
    _Trno_Controller.text = _powtRModel.trNo.toString();
    // args['TrNo'].toString();
    _serialNo_Controller.text = _powtRModel.serialNo.toString();
    //args['Serial_No'];
    _hv_1u_1v_controller.text = _powtRModel.hv_1u_1v.toString();
    _hv_1v_1w_controller.text = _powtRModel.hv_1v_1w.toString();
    _hv_1w_1u_controller.text = _powtRModel.hv_1w_1u.toString();
    _hv_1u_1n_controller.text = _powtRModel.hv_1u_1n.toString();
    _hv_1v_1n_controller.text = _powtRModel.hv_1v_1n.toString();
    _hv_1w_1n_controller.text = _powtRModel.hv_1w_1n.toString();

    _lv_2u_2v_controller.text = _powtRModel.lv_2u_2v.toString();
    _lv_2v_2w_controller.text = _powtRModel.lv_2v_2w.toString();
    _lv_2w_2u_controller.text = _powtRModel.lv_2w_2u.toString();
    _lv_2u_2n_controller.text = _powtRModel.lv_2u_2n.toString();
    _lv_2v_2n_controller.text = _powtRModel.lv_2v_2n.toString();
    _lv_2w_2n_controller.text = _powtRModel.lv_2w_2n.toString();
    _tap_controller.text = _powtRModel.tapPosition.toString();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final Powt_R_Model ntr = watchOnly((Powt_R_Provider x) => x.powt_R_Model);
    getReport();
    var mob =
        const Text('Edit powt-Ratio Details', style: TextStyle(fontSize: 15));
    var desk =
        const Text('Edit powt-Ratio Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  //add to remote database
                  var url = Uri.parse('${Env.URL_PREFIX}/powtRTest/' +
                  ...
                  if (ntr1.vectorGroup == "Dyn1" ||
                    ...
                    _hv_1u_1n_controller.text = '0.00';
                    _hv_1v_1n_controller.text = '0.00';
                    _hv_1w_1n_controller.text = '0.00';
                  }
                  if (ntr1.vectorGroup == "YNd1" ||
                      ntr1.vectorGroup == "YNd11") {
                    _lv_2u_2n_controller.text = '0.00';
                    _lv_2v_2n_controller.text = '0.00';
                    _lv_2w_2n_controller.text = '0.00';
                  }
                  ...
                  if (response.statusCode == success_code ||
                    ...
                    final Powt_R_Model powtRReportToLocal = Powt_R_Model(
                    ...
                    getX((Powt_R_Provider x) =>
                        x.updatePowtr(powtRReportToLocal, args['id']));
                    Navigator.pop(context);

                    Navigator.popAndPushNamed(context, '/detail_Powt_R',
                        arguments: {
                          'id': args['id'],
