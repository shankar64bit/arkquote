...
String etype_radio = 'sc';
final _formKey = GlobalKey<FormState>();

class AddScDetails extends StatelessWidget with GetItMixin {
  Map args = {};
  DateTime _dateOfTesting;
  AddScDetails(this.args, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    setTrNo();
    var mob = Text('Add Surge Counter Details', style: TextStyle(fontSize: 17));
    var desk =
        Text('Add Surge Counter Details', style: TextStyle(fontSize: 20));
          ...
          IconButton(
              onPressed: () async {
                if (!_formKey.currentState.validate()) {
                  ...
                  final ScModel scToLocal = ScModel(
                  ...
                  print(scToLocal);
                  getX((ScProvider x) => x.addSc(scToLocal, _dateOfTesting));
